...
object PermissionUtils {
    ...
    class PermissionDeniedDialog : DialogFragment() {
        ...
        override fun onDismiss(dialog: DialogInterface) {
            // Invocar el métoodo onDismiss de la clase base, para que haya consistencia en el estado
            // de la app.
        ...
        companion object {
            ...
            fun newInstance(finishActivity: Boolean): PermissionDeniedDialog {
                // Enviar el argumento, para determinar si se debe o no, terminar la app.
